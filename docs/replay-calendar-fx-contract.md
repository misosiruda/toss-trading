...
- [Official Market Calendar Source Acquisition 계획](official-market-calendar-source-acquisition-plan.md)은 official entry point, raw byte 보존, provenance metadata, full coverage와 fail-closed acceptance 기준을 고정한다. 실제 source acquisition과 adapter 구현은 아직 수행하지 않았다.

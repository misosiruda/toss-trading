...
- 기본값은 `slippageBps=0`, `feeBps=0`, `taxBps=0`, `marketImpactBpsPerParticipationRate=0`, `allowFractionalShares=true`입니다.
- 옵션으로 slippage, fee, tax, participation 기반 market impact, fill ratio, whole-share 체결을 켤 수 있습니다.
- 모든 가상 체결은 `sourcePriceKrw`, `priceKrw`, `grossAmountKrw`, `netAmountKrw`, `feeKrw`, `taxKrw`, `slippageKrw`, `impactCostKrw`, `priceSourceRefs`를 남길 수 있습니다.

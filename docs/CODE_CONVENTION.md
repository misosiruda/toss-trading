...
KRX holiday response ownership은 caller byte view를 즉시 zeroize하는 process-local opaque
handle로만 유지한다. Handle은 raw metadata object, row getter, callback, enumerable field,

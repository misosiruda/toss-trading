...
| Official calendar evidence | exclusive writer와 full legacy rule/fixture projection 구현, ingestion 없음 | `replay-calendar-fx-contract.md`, `officialMarketCalendarEvidenceArtifactWriter.ts`와 `officialMarketCalendarLegacyProjection.ts` | KRX/NYSE provenance, full coverage와 freshness를 갖춘 artifact ingestion을 별도 구현 |

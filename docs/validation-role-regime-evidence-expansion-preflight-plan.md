...
| Official calendar evidence | exclusive writer 구현, ingestion과 legacy projection 없음 | `replay-calendar-fx-contract.md`와 `officialMarketCalendarEvidenceArtifactWriter.ts` | KRX/NYSE provenance, full coverage와 freshness를 갖춘 artifact ingestion 및 full legacy rule/fixture projection을 별도 구현 |

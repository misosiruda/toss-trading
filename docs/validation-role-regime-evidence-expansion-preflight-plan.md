...
aggregation과 candidate partition을 다시 대조해 partition summary를
내부 생성하고, partition의 accepted consolidation만 cross-role shared
exclusion state에 연결한다. Eligibility/calendar exclusion과 cross-source

...
전체 재생한 뒤 selector root에 이어진 `bound_to_mandate`마다 위 stored mandate/source 대조를
실행한다. Root의 portfolio/policy/bucket, reservation ID/hash, 전역 slot, 금액과 set/assignment 참조를

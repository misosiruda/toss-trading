...
import { readRiskGateTracePageData } from "@/lib/dashboardViewModels";
import { RiskGateTracePanel } from "../RiskGateTracePanel";

export const dynamic = "force-dynamic";
export const revalidate = 0;

export default async function RiskGateTracePage() {
  const pageData = await readRiskGateTracePageData();
  ...
  return (
    <main className="min-h-screen px-4 py-5 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-5">
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--muted)]">
                Backend ViewModel 기준으로 AI decision, deterministic risk
                verdict, simulated execution status를 조회합니다.
              </p>
            </div>
            <nav
              aria-label="Risk gate navigation"
        ...
        <section
          aria-label="Risk gate safety boundary"
        ...
        <RiskGateTracePanel result={pageData.riskGate} variant="detail" />

...
/** Binds stored marks/FX, pending progress, mandate/execution origins, reservation roots/bound mandates/consumption and active policy through destination fsync.
 ...
 * Pending reservation balance, allocation, accounting, external trust and current execution remain separate gates.
 */

...
import {
  ...
  type VerifiedOfficialMarketCalendarKrxLegacyWordPlcBtePapxReference
} from "./officialMarketCalendarKrxLegacyWordPlcBtePapxReference.js";
import {
  verifyOfficialMarketCalendarKrxLegacyWordPlcBtePapx,
  type VerifiedOfficialMarketCalendarKrxLegacyWordPlcBtePapx
...
import {
  ...
  type VerifiedOfficialMarketCalendarKrxLegacyWordGrpPrls
...
import {
  ...
  type VerifiedOfficialMarketCalendarKrxLegacyWordTableTextMarks
} from "./officialMarketCalendarKrxLegacyWordTableTextMarks.js";
import {
  verifyOfficialMarketCalendarKrxLegacyWordTableRowGrouping,
  type VerifiedOfficialMarketCalendarKrxLegacyWordTableRowGrouping
...
export interface OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument {
  readonly [krxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocumentBrand]: true;
  toJSON(): never;
}

export interface OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument {
  readonly [krxLegacyDownloadWordPlcBtePapxVerifiedDocumentBrand]: true;
  toJSON(): never;
}
...
export interface OfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument {
  readonly [krxLegacyDownloadWordGrpPrlVerifiedDocumentBrand]: true;
  toJSON(): never;
}
...
export interface OfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument {
  readonly [krxLegacyDownloadWordTableTextMarksVerifiedDocumentBrand]: true;
  toJSON(): never;
}
export interface OfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument {
  readonly [krxLegacyDownloadWordTableRowGroupingVerifiedDocumentBrand]: true;
  toJSON(): never;
}
...
interface ReadyWordPlcBtePapxReferenceVerifiedDocumentState extends ReadyWordMainDocumentVerifiedDocumentState {
  plcBtePapxReference: VerifiedOfficialMarketCalendarKrxLegacyWordPlcBtePapxReference;
}

interface ReadyWordPlcBtePapxVerifiedDocumentState extends ReadyWordPlcBtePapxReferenceVerifiedDocumentState {
  plcBtePapx: VerifiedOfficialMarketCalendarKrxLegacyWordPlcBtePapx;
}
...
interface ReadyWordGrpPrlVerifiedDocumentState extends ReadyWordPapxFkpVerifiedDocumentState {
  grpPrls: VerifiedOfficialMarketCalendarKrxLegacyWordGrpPrls;
}
...
interface ReadyWordTableTextMarksVerifiedDocumentState extends ReadyWordDirectParagraphPropertiesVerifiedDocumentState {
  tableTextMarks: VerifiedOfficialMarketCalendarKrxLegacyWordTableTextMarks;
}
interface ReadyWordTableRowGroupingVerifiedDocumentState extends ReadyWordTableTextMarksVerifiedDocumentState {
  tableRowGrouping: VerifiedOfficialMarketCalendarKrxLegacyWordTableRowGrouping;
}
...
type WordMainDocumentVerifiedDocumentState =
  ...
  | DisposedState;
type WordPlcBtePapxReferenceVerifiedDocumentState =
  | ReadyWordPlcBtePapxReferenceVerifiedDocumentState
  | DisposedState;
type WordPlcBtePapxVerifiedDocumentState =
  | ReadyWordPlcBtePapxVerifiedDocumentState
  | DisposedState;
...
type WordPapxFkpVerifiedDocumentState =
  ...
  | DisposedState;
type WordGrpPrlVerifiedDocumentState =
  | ReadyWordGrpPrlVerifiedDocumentState
  | DisposedState;
...
type WordDirectParagraphPropertiesVerifiedDocumentState =
  ...
  | DisposedState;
type WordTableTextMarksVerifiedDocumentState =
  | ReadyWordTableTextMarksVerifiedDocumentState
  | DisposedState;
type WordTableRowGroupingVerifiedDocumentState =
  | ReadyWordTableRowGroupingVerifiedDocumentState
  | DisposedState;
...
>();
const wordPlcBtePapxReferenceVerifiedDocumentStates = new WeakMap<
  object,
  WordPlcBtePapxReferenceVerifiedDocumentState
>();
const wordPlcBtePapxVerifiedDocumentStates = new WeakMap<
  object,
  WordPlcBtePapxVerifiedDocumentState
>();
...
>();
const wordGrpPrlVerifiedDocumentStates = new WeakMap<
  object,
  WordGrpPrlVerifiedDocumentState
>();
...
>();
const wordTableTextMarksVerifiedDocumentStates = new WeakMap<
  object,
  WordTableTextMarksVerifiedDocumentState
>();
const wordTableRowGroupingVerifiedDocumentStates = new WeakMap<
  object,
  WordTableRowGroupingVerifiedDocumentState
>();
...
export function consumeOfficialMarketCalendarKrxLegacyWordMainDocumentVerifiedDocumentToWordPlcBtePapxReferenceVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordMainDocumentVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordMainDocumentVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") {
    throw new Error("KRX legacy word-main-document-verified document must be ready and come from the fixed Word main document consumer");
  }
  let plcBtePapxReference:
  ...
  try {
    ...
    if (
      plcBtePapxReference.nFib !== state.mainDocument.nFib ||
      plcBtePapxReference.tableStreamName !== state.mainDocument.tableStreamName ||
      plcBtePapxReference.plcBtePapxBytes.length !==
        plcBtePapxReference.lcbPlcfBtePapx ||
      plcBtePapxReference.bytesOwnership !== "caller_owned_copy" ||
      plcBtePapxReference.plcBtePapxReferenceVerified !== true ||
      plcBtePapxReference.plcBtePapxFramingStatus !== "not_parsed" ||
      plcBtePapxReference.papxFkpStatus !== "not_parsed" ||
      plcBtePapxReference.paragraphPropertiesStatus !== "not_parsed" ||
      plcBtePapxReference.sourceRoleStatus !== "candidate_not_accepted"
    ) {
      throw new Error("KRX legacy Word PlcBtePapx reference result is invalid");
    }
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordPlcBtePapxReferenceVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-plc-bte-papx-reference-verified document cannot be serialized or exported");
    });
    wordPlcBtePapxReferenceVerifiedDocumentStates.set(verifiedHandle, {
      ...state,
      plcBtePapxReference
    });
    wordMainDocumentVerifiedDocumentStates.set(handleObject, {
      status: "disposed"
    });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument;
  } finally {
    if (!transferred) {
      if (plcBtePapxReference !== undefined) {
        zeroizeBytes(plcBtePapxReference.plcBtePapxBytes);
      }
      disposeWordMainDocumentVerifiedDocumentObject(handleObject);
    }
  }
...
export function disposeOfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordPlcBtePapxReferenceVerifiedDocumentStates.has(handleObject)) {
    throw new Error("KRX legacy word-plc-bte-papx-reference-verified document must come from the fixed Word PlcBtePapx reference consumer");
  }
  disposeWordPlcBtePapxReferenceVerifiedDocumentObject(handleObject);
}

export function consumeOfficialMarketCalendarKrxLegacyWordPlcBtePapxReferenceVerifiedDocumentToWordPlcBtePapxVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxReferenceVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordPlcBtePapxReferenceVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") {
    throw new Error("KRX legacy word-plc-bte-papx-reference-verified document must be ready and come from the fixed Word PlcBtePapx reference consumer");
  }
  let transferred = false;
  try {
    const plcBtePapx = verifyOfficialMarketCalendarKrxLegacyWordPlcBtePapx(
      state.rawDocumentBytes
    );
    if (
      plcBtePapx.nFib !== state.plcBtePapxReference.nFib ||
      plcBtePapx.tableStreamName !== state.plcBtePapxReference.tableStreamName ||
      plcBtePapx.fcPlcfBtePapx !== state.plcBtePapxReference.fcPlcfBtePapx ||
      plcBtePapx.lcbPlcfBtePapx !== state.plcBtePapxReference.lcbPlcfBtePapx ||
      plcBtePapx.fileOffsets.length !== plcBtePapx.entries.length + 1 ||
      plcBtePapx.plcBtePapxFramingVerified !== true ||
      plcBtePapx.pnFkpPapxDescriptorsVerified !== true ||
      plcBtePapx.fkpReferencesStatus !== "not_verified" ||
      plcBtePapx.papxFkpStatus !== "not_parsed" ||
      plcBtePapx.paragraphPropertiesStatus !== "not_parsed" ||
      plcBtePapx.sourceRoleStatus !== "candidate_not_accepted"
    ) {
      throw new Error("KRX legacy Word PlcBtePapx result is invalid");
    }
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordPlcBtePapxVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-plc-bte-papx-verified document cannot be serialized or exported");
    });
    wordPlcBtePapxVerifiedDocumentStates.set(verifiedHandle, {
      ...state,
      plcBtePapx
    });
    wordPlcBtePapxReferenceVerifiedDocumentStates.set(handleObject, {
      status: "disposed"
    });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument;
  } finally {
    if (!transferred) {
      disposeWordPlcBtePapxReferenceVerifiedDocumentObject(handleObject);
    }
...
export function disposeOfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordPlcBtePapxVerifiedDocumentStates.has(handleObject)) {
    throw new Error("KRX legacy word-plc-bte-papx-verified document must come from the fixed Word PlcBtePapx consumer");
  }
  disposeWordPlcBtePapxVerifiedDocumentObject(handleObject);
}

export function consumeOfficialMarketCalendarKrxLegacyWordPlcBtePapxVerifiedDocumentToWordPapxFkpReferencesVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPlcBtePapxVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordPapxFkpReferencesVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordPlcBtePapxVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-plc-bte-papx-verified document must be ready and come from the fixed Word PlcBtePapx consumer");
  let papxFkpReferences: VerifiedOfficialMarketCalendarKrxLegacyWordPapxFkpReferences | undefined;
  let transferred = false;
  try {
    papxFkpReferences = verifyOfficialMarketCalendarKrxLegacyWordPapxFkpReferences(state.rawDocumentBytes);
    if (
      papxFkpReferences.nFib !== state.plcBtePapx.nFib ||
      papxFkpReferences.tableStreamName !== state.plcBtePapx.tableStreamName ||
      papxFkpReferences.cbMac !== state.textRanges.cbMac ||
      papxFkpReferences.references.length !== state.plcBtePapx.entries.length ||
      papxFkpReferences.references.some((reference, index) => {
        const entry = state.plcBtePapx.entries[index];
        return entry === undefined ||
          reference.index !== entry.index ||
          reference.fcStart !== entry.fcStart ||
          reference.fcEnd !== entry.fcEnd ||
          reference.pn !== entry.pn ||
          reference.fkpByteOffset !== entry.fkpByteOffset ||
          reference.fkpByteLength !== 512 ||
          reference.fkpBytes.length !== 512 ||
          reference.bytesOwnership !== "caller_owned_copy";
      }) ||
      papxFkpReferences.papxFkpReferencesVerified !== true ||
      papxFkpReferences.papxFkpFramingStatus !== "not_parsed" ||
      papxFkpReferences.papxStatus !== "not_parsed" ||
      papxFkpReferences.paragraphPropertiesStatus !== "not_parsed" ||
      papxFkpReferences.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word PapxFkp references result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordPapxFkpReferencesVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-papx-fkp-references-verified document cannot be serialized or exported");
    });
    wordPapxFkpReferencesVerifiedDocumentStates.set(verifiedHandle, { ...state, papxFkpReferences });
    wordPlcBtePapxVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordPapxFkpReferencesVerifiedDocument;
  } finally {
    if (!transferred) {
      if (papxFkpReferences !== undefined) zeroizePapxFkpReferenceBytes(papxFkpReferences);
      disposeWordPlcBtePapxVerifiedDocumentObject(handleObject);
    }
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordPapxFkpReferencesVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPapxFkpReferencesVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordPapxFkpReferencesVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-papx-fkp-references-verified document must come from the fixed Word PapxFkp references consumer");
...
export function consumeOfficialMarketCalendarKrxLegacyWordPapxFkpVerifiedDocumentToWordGrpPrlVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordPapxFkpVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordPapxFkpVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-papx-fkp-verified document must be ready and come from the fixed Word PapxFkp consumer");
  let grpPrls: VerifiedOfficialMarketCalendarKrxLegacyWordGrpPrls | undefined;
  let transferred = false;
  try {
    grpPrls = verifyOfficialMarketCalendarKrxLegacyWordGrpPrls(state.rawDocumentBytes);
    const paragraphCount = state.papxFkp.pages.reduce((count, page) => count + page.paragraphs.length, 0);
    if (
      grpPrls.nFib !== state.papxFkp.nFib ||
      grpPrls.tableStreamName !== state.papxFkp.tableStreamName ||
      grpPrls.groups.length !== paragraphCount ||
      grpPrls.groups.some((group) => group.prls.some((prl) => prl.operandBytes.length !== prl.operandByteLength || prl.bytesOwnership !== "caller_owned_copy")) ||
      grpPrls.grpprlAndIstdFramingVerified !== true ||
      grpPrls.sprmFramingVerified !== true ||
      grpPrls.tDefTableLengthStatus !== "supported" ||
      grpPrls.pChgTabs255Status !== "rejected_unsupported" ||
      grpPrls.sprmSemanticsStatus !== "not_verified" ||
      grpPrls.tableSemanticsStatus !== "not_verified" ||
      grpPrls.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word GrpPrl result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordGrpPrlVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-grpprl-verified document cannot be serialized or exported");
    });
    wordGrpPrlVerifiedDocumentStates.set(verifiedHandle, { ...state, grpPrls });
    wordPapxFkpVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument;
  } finally {
    if (!transferred) {
      if (grpPrls !== undefined) zeroizeGrpPrlBytes(grpPrls);
      disposeWordPapxFkpVerifiedDocumentObject(handleObject);
    }
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordGrpPrlVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-grpprl-verified document must come from the fixed Word GrpPrl consumer");
  disposeWordGrpPrlVerifiedDocumentObject(handleObject);
}

export function consumeOfficialMarketCalendarKrxLegacyWordGrpPrlVerifiedDocumentToWordParagraphBoundariesVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordGrpPrlVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordParagraphBoundariesVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordGrpPrlVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-grpprl-verified document must be ready and come from the fixed Word GrpPrl consumer");
  let transferred = false;
  try {
    const paragraphBoundaries = verifyOfficialMarketCalendarKrxLegacyWordParagraphBoundaries(state.rawDocumentBytes);
    if (
      paragraphBoundaries.nFib !== state.mainDocument.nFib ||
      paragraphBoundaries.tableStreamName !== state.mainDocument.tableStreamName ||
      paragraphBoundaries.mainDocumentCpStart !== state.mainDocument.mainDocumentCpStart ||
      paragraphBoundaries.mainDocumentCpEnd !== state.mainDocument.mainDocumentCpEnd ||
      paragraphBoundaries.paragraphs.length === 0 ||
      paragraphBoundaries.paragraphs[0]?.cpStart !== 0 ||
      paragraphBoundaries.paragraphs.at(-1)?.cpEnd !== state.mainDocument.mainDocumentCpEnd ||
      paragraphBoundaries.paragraphs.some((paragraph, index) => paragraph.index !== index || paragraph.cpEnd - paragraph.cpStart !== paragraph.characterCount || (index > 0 && paragraph.cpStart !== paragraphBoundaries.paragraphs[index - 1]?.cpEnd)) ||
      paragraphBoundaries.paragraphBoundaryAlgorithm !== "ms_doc_2_4_2_piece_aware" ||
      paragraphBoundaries.paragraphBoundaryMarksVerified !== true ||
      paragraphBoundaries.pcdPrmStatus !== "not_applied_not_required_for_boundaries" ||
      paragraphBoundaries.tablePropertyBindingStatus !== "terminal_papx_identified_properties_not_applied" ||
      paragraphBoundaries.tableRowCellBoundaryStatus !== "not_verified" ||
      paragraphBoundaries.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word paragraph boundaries result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordParagraphBoundariesVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-paragraph-boundaries-verified document cannot be serialized or exported");
    });
    wordParagraphBoundariesVerifiedDocumentStates.set(verifiedHandle, { ...state, paragraphBoundaries });
    wordGrpPrlVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordParagraphBoundariesVerifiedDocument;
  } finally {
    if (!transferred) disposeWordGrpPrlVerifiedDocumentObject(handleObject);
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordParagraphBoundariesVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordParagraphBoundariesVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordParagraphBoundariesVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-paragraph-boundaries-verified document must come from the fixed Word paragraph boundaries consumer");
...
export function consumeOfficialMarketCalendarKrxLegacyWordDirectParagraphPropertiesVerifiedDocumentToWordTableTextMarksVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordDirectParagraphPropertiesVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordDirectParagraphPropertiesVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-direct-paragraph-properties-verified document must be ready and come from the fixed Word direct paragraph properties consumer");
  let transferred = false;
  try {
    const tableTextMarks = verifyOfficialMarketCalendarKrxLegacyWordTableTextMarks(state.rawDocumentBytes);
    if (
      tableTextMarks.nFib !== state.directParagraphProperties.nFib ||
      tableTextMarks.tableStreamName !== state.directParagraphProperties.tableStreamName ||
      tableTextMarks.paragraphs.length !== state.directParagraphProperties.paragraphs.length ||
      tableTextMarks.paragraphs.some((paragraph, index) => paragraph.index !== state.directParagraphProperties.paragraphs[index]?.index || paragraph.cpStart !== state.directParagraphProperties.paragraphs[index]?.cpStart || paragraph.cpEnd !== state.directParagraphProperties.paragraphs[index]?.cpEnd || paragraph.markCp !== state.directParagraphProperties.paragraphs[index]?.markCp) ||
      tableTextMarks.depthOneCellAndTtpMarksVerified !== true ||
      tableTextMarks.nestedCellAndTtpMarksVerified !== true ||
      tableTextMarks.ttpPrecedingCellMarkVerified !== true ||
      tableTextMarks.tableRowCellBoundaryStatus !== "marks_classified_not_grouped" ||
      tableTextMarks.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word table text marks result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordTableTextMarksVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-table-text-marks-verified document cannot be serialized or exported");
    });
    wordTableTextMarksVerifiedDocumentStates.set(verifiedHandle, { ...state, tableTextMarks });
    wordDirectParagraphPropertiesVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument;
  } finally {
    if (!transferred) disposeWordDirectParagraphPropertiesVerifiedDocumentObject(handleObject);
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordTableTextMarksVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-table-text-marks-verified document must come from the fixed Word table text marks consumer");
  disposeWordTableTextMarksVerifiedDocumentObject(handleObject);
}

export function consumeOfficialMarketCalendarKrxLegacyWordTableTextMarksVerifiedDocumentToWordTableRowGroupingVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordTableTextMarksVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordTableTextMarksVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-table-text-marks-verified document must be ready and come from the fixed Word table text marks consumer");
  let transferred = false;
  try {
    const tableRowGrouping = verifyOfficialMarketCalendarKrxLegacyWordTableRowGrouping(state.rawDocumentBytes);
    if (
      tableRowGrouping.nFib !== state.tableTextMarks.nFib ||
      tableRowGrouping.tableStreamName !== state.tableTextMarks.tableStreamName ||
      tableRowGrouping.rows.some((row, index) => row.index !== index || row.cpEnd <= row.cpStart || row.cells.length === 0 || row.cells.some((cell, cellIndex) => cell.index !== cellIndex || cell.cpEnd <= cell.cpStart)) ||
      tableRowGrouping.tableRowCellBoundaryStatus !== "grouped" ||
      tableRowGrouping.nestedRowBoundaryStatus !== "grouped" ||
      tableRowGrouping.sourceRowProjectionStatus !== "not_projected" ||
      tableRowGrouping.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word table row grouping result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordTableRowGroupingVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-table-row-grouping-verified document cannot be serialized or exported");
    });
    wordTableRowGroupingVerifiedDocumentStates.set(verifiedHandle, { ...state, tableRowGrouping });
    wordTableTextMarksVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument;
  } finally {
    if (!transferred) disposeWordTableTextMarksVerifiedDocumentObject(handleObject);
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordTableRowGroupingVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-table-row-grouping-verified document must come from the fixed Word table row grouping consumer");
  disposeWordTableRowGroupingVerifiedDocumentObject(handleObject);
}

export function consumeOfficialMarketCalendarKrxLegacyWordTableRowGroupingVerifiedDocumentToWordSourceRowsVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordTableRowGroupingVerifiedDocument
): OfficialMarketCalendarKrxLegacyDownloadWordSourceRowsVerifiedDocument {
  const handleObject = assertHandleObject(handle);
  const state = wordTableRowGroupingVerifiedDocumentStates.get(handleObject);
  if (state === undefined || state.status === "disposed") throw new Error("KRX legacy word-table-row-grouping-verified document must be ready and come from the fixed Word table row grouping consumer");
  let transferred = false;
  try {
    const sourceRows = verifyOfficialMarketCalendarKrxLegacyWordSourceRows(state.rawDocumentBytes);
    if (
      sourceRows.nFib !== state.tableRowGrouping.nFib ||
      sourceRows.tableStreamName !== state.tableRowGrouping.tableStreamName ||
      sourceRows.rows.length !== state.tableRowGrouping.rows.length ||
      sourceRows.rows.some((row, index) => row.index !== state.tableRowGrouping.rows[index]?.index || row.cpStart !== state.tableRowGrouping.rows[index]?.cpStart || row.cpEnd !== state.tableRowGrouping.rows[index]?.cpEnd || row.cells.length !== state.tableRowGrouping.rows[index]?.cells.length) ||
      sourceRows.sourceRowProjectionStatus !== "structural_text_projected" ||
      sourceRows.terminalMarkHandling !== "removed_from_content_preserved_in_raw" ||
      sourceRows.internalControlCodeHandling !== "preserved" ||
      sourceRows.columnSemanticsStatus !== "not_interpreted" ||
      sourceRows.sourceRoleStatus !== "candidate_not_accepted"
    ) throw new Error("KRX legacy Word source rows result is invalid");
    const verifiedHandle = createOpaqueHandle(() => {
      disposeWordSourceRowsVerifiedDocumentObject(verifiedHandle);
      throw new Error("KRX legacy word-source-rows-verified document cannot be serialized or exported");
    });
    wordSourceRowsVerifiedDocumentStates.set(verifiedHandle, { ...state, sourceRows });
    wordTableRowGroupingVerifiedDocumentStates.set(handleObject, { status: "disposed" });
    transferred = true;
    return verifiedHandle as OfficialMarketCalendarKrxLegacyDownloadWordSourceRowsVerifiedDocument;
  } finally {
    if (!transferred) disposeWordTableRowGroupingVerifiedDocumentObject(handleObject);
  }
}

export function disposeOfficialMarketCalendarKrxLegacyDownloadWordSourceRowsVerifiedDocument(
  handle: OfficialMarketCalendarKrxLegacyDownloadWordSourceRowsVerifiedDocument
): void {
  const handleObject = assertHandleObject(handle);
  if (!wordSourceRowsVerifiedDocumentStates.has(handleObject)) throw new Error("KRX legacy word-source-rows-verified document must come from the fixed Word source rows consumer");
...
function disposeWordPlcBtePapxReferenceVerifiedDocumentObject(
  handle: object
): void {
  const state = wordPlcBtePapxReferenceVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    ...
    wordPlcBtePapxReferenceVerifiedDocumentStates.set(handle, {
      status: "disposed"
    });
  }
}

function disposeWordPlcBtePapxVerifiedDocumentObject(handle: object): void {
  const state = wordPlcBtePapxVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    zeroizeBytes(state.plcBtePapxReference.plcBtePapxBytes);
    zeroizeTextPieceBytes(state.textBytes);
    ...
    wordPlcBtePapxVerifiedDocumentStates.set(handle, { status: "disposed" });
  }
}

function disposeWordPapxFkpReferencesVerifiedDocumentObject(handle: object): void {
  const state = wordPapxFkpReferencesVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    ...
    wordPapxFkpReferencesVerifiedDocumentStates.set(handle, { status: "disposed" });
  }
}

function zeroizePapxFkpReferenceBytes(
...
function disposeWordGrpPrlVerifiedDocumentObject(handle: object): void {
  const state = wordGrpPrlVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    ...
    wordGrpPrlVerifiedDocumentStates.set(handle, { status: "disposed" });
  }
}

function zeroizeGrpPrlBytes(
  grpPrls: VerifiedOfficialMarketCalendarKrxLegacyWordGrpPrls
): void {
  for (const group of grpPrls.groups) {
    for (const prl of group.prls) zeroizeBytes(prl.operandBytes);
  }
}

function disposeWordParagraphBoundariesVerifiedDocumentObject(handle: object): void {
  const state = wordParagraphBoundariesVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    zeroizeGrpPrlBytes(state.grpPrls);
    zeroizePapxFkpBytes(state.papxFkp);
...
function disposeWordTableTextMarksVerifiedDocumentObject(handle: object): void {
  const state = wordTableTextMarksVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    zeroizeGrpPrlBytes(state.grpPrls);
    zeroizePapxFkpBytes(state.papxFkp);
    ...
    wordTableTextMarksVerifiedDocumentStates.set(handle, { status: "disposed" });
  }
}

function disposeWordTableRowGroupingVerifiedDocumentObject(handle: object): void {
  const state = wordTableRowGroupingVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    zeroizeGrpPrlBytes(state.grpPrls);
    zeroizePapxFkpBytes(state.papxFkp);
    ...
    wordTableRowGroupingVerifiedDocumentStates.set(handle, { status: "disposed" });
  }
}

function disposeWordSourceRowsVerifiedDocumentObject(handle: object): void {
  const state = wordSourceRowsVerifiedDocumentStates.get(handle);
  if (state === undefined || state.status === "disposed") return;
  try {
    zeroizeGrpPrlBytes(state.grpPrls);
    zeroizePapxFkpBytes(state.papxFkp);

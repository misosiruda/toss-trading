...
import { replayRangeText } from "./reportViewHelpers.js";

export function renderPortfolioPerformance(data) {
...
export function renderBenchmarkComparison(data) {
...
export function renderExecutionCostDiagnostics(data) {
...
export function renderMarketMonitor(data) {
...
export function renderExposureBreakdown(data) {
...
export function renderEventCoverage(data) {
...
export function renderIncomeGoalPanel(data) {
...
export function renderPortfolioRiskMetrics(data) {
  const timeline = portfolioPerformanceTimeline(data);
  const portfolio = currentPortfolioSummary(data, timeline);
